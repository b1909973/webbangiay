	...
	<div class="container">
		  ...
		  <div class=" col-md-12 content ">
					...
					<div class="row col-md-12  mx-auto p-3 mt-2  rounded">
									...
									<a href="/danggiao" class="shipping text-decoration-none col-12 col-md-4 text-center p-2 link-secondary border-bottom  fs-5" value="2" style="color:#ff4b2b;">Đang giao</a>
						...
						<section class="w-100 p-4 text-center">
							...
							<table class="table table-bordered">
							  ...
							  <?php foreach ($dh as $key => $value) {
										...
										?>
								  <tr  style="border: 2px solid rgb(19, 15, 15)">
								<td  ><span class="dem" style="color:#ff4b2b;"></span></td>
								<td >
								...
								<?php foreach ($value->sanpham as $key => $value1) {
									...
									<td><span ><i class="fas fa-shuttle-van text-warning fs-3	"></i></span></td>
								</tr>
								<?php  } ?>
							  </tbody>
							  							</table>
