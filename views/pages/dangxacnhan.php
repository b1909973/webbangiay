	...
	<div class="container">
		  ...
		  <div class=" col-md-12 content ">
					...
					<div class="row col-md-12  mx-auto p-3 mt-2  rounded">
									...
									<a href="/dangxacnhan" class="waiting text-decoration-none col-12  col-md-4 text-center  p-2 border-bottom link-secondary fs-5  " value="0" style="color:#ff4b2b;">Chờ xác nhận</a>
									...
									<a href="/dagiao" class="shipped text-decoration-none col-12 col-md-4 text-center  p-2  border-bottom    fs-5" value="3" style="color:#ff416c;">Đã giao</a>
						...
						<section class="w-100 p-4 text-center">
							...
							<table class="table table-bordered">
								...
								<tr  style="border: 2px solid rgb(19, 15, 15)">
								  ...
								  <th scope="col" style="color:#ff4b2b;">Xoá</th>
								</tr>
							  </thead>
							  ...
							  <tbody>
											  ...
											  ?>
								  <tr  style="border: 2px solid rgb(19, 15, 15)">
								<td style="" ><span class="dem" style="color:#ff4b2b;"></span></td>
								<td >
									...
									<td>	<img src="css/frontend/image/<?= $value1->thuonghieu->TenThuongHieu?>/<?= $value1->hinhanh[0]->HinhAnh ?>" alt="" style="width: 80px;"></td></td>
										...
										<td> <button class="btn btn-outline-secondary" disabled><span  style="color:#ff4b2b;"><?= $value1->pivot->SoLuong?></span></button></td>
									</tr>
									...
									<td class="text-center tong " style="color:#1e9600;"><?= $tong ?><span><b class="fs-5">đ</b> </span></td>
									<td><button class="btn reE" value="<?= $value->id?>"><i class="fas fa-trash-alt text-danger" style=";"></i></button></td>
								</tr>
								<?php } ?>
							  </tbody>
							  							</table>
